        ...
        <div style={card}>
          ...
          {countdown && !connectionLost && (
            <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '6px' }}>
              Mati otomatis: <span style={{ color: 'var(--accent)', fontWeight: 700, fontVariantNumeric: 'tabular-nums' }}>{countdown}</span>
            </p>
          )}
        </div>
...
const pageStyle: React.CSSProperties = { padding: '28px 24px', maxWidth: '900px', margin: '0 auto' };
